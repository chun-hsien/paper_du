---
title: "0606_3_cat_true_DIF_analysis"
...
## True Relationship DIF analysis
```{r}
# 2022.06.06
# MY PCM DIF
rm(list=ls())
...
dat <- read.csv("12_3_45_item49-64.csv")
...
plot(z, ylim = c(min.y, max.y),
     ylab = "Z值", xlab = "試題", main = "性別在真有之情試題之差異試題功能檢定統計量",
     axes=FALSE)
...
legend("topright", c("Z 統計量", "顯著差異邊界"),
       pch = c(1, NA), lty = c(NA, 2), col = c("black", "red"), cex = .8)
```
...
```
#### Create scatterplot of item measures with 95% confidence bands and DIF Scatterplot:
