---
title: "True relationship 5 items DIF analysis"
...
### True Relationships 5 items DIF Analysis
```{r}
# 2022.05.11
# MY PCM DIF
rm(list=ls())
...
### Load data and rename items' names 
```{r}
...
```
### Create scatterplot of item measures with 95% confidence 
### DIF Scatterplot:
```{r}
